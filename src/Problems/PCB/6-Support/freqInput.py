...
### MATERIAL DEFINITION ###
# MMTS Consisten Unit System#
# Base Dimensional Quantities
# Length = mm
# Mass = tonne
# Time = second
#
...
in_json = [ { "name": "patch_creation_surface_square", "patch_id": 1, "width": 5, "refinement": { "degrees": [2,2], "num_elems": [2,2] }, "positioning": { "origin": [0,.5,0] } },
            ...
            { "name": "material_isotropic_elastoplastic", "material_id": 1, "E": 24000, "nu": 0.33, "rho": 1.85e-9, "thermal_expansion": 0.0000093, "yield_type": "J2", "effective_plastic_work_measure": "plastic_work", "plastic_work_threshold": 0  },
