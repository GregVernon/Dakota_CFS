...
# Dakota imports
sys.path.append("C:/Program Files/Dakota/share/dakota/Python/dakota")
...
qois = [qoi.QoiAnchor("objective", 1, qoi.FIELDS, 1, qoi.FIELDS, qoi.AFTER, "ObjVal"),
        ...
        qoi.QoiAnchor("nlcon_3", 1, qoi.FIELDS, 1, qoi.FIELDS, qoi.AFTER, "nlcon_3"),
        qoi.QoiAnchor("nlcon_4", 1, qoi.FIELDS, 1, qoi.FIELDS, qoi.AFTER, "nlcon_4"),
        qoi.QoiAnchor("nlcon_5", 1, qoi.FIELDS, 1, qoi.FIELDS, qoi.AFTER, "nlcon_5"),
        qoi.QoiAnchor("nlcon_6", 1, qoi.FIELDS, 1, qoi.FIELDS, qoi.AFTER, "nlcon_6"),
        ]
